package com.faas.core.rest.call.utility;
...
public class UtilityRestCall {
    ...
    public Map<String,String> urlShortenerRest(String httpUrl) throws IOException {
        ...
        String response = restCall.sendPostFormRequest(restCall.urlBuilder(AppConstant.URL_SHORTENER_API_URL,"/create",null),formData);
        if (response != null){
