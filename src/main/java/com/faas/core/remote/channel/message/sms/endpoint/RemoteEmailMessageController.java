...
import com.faas.core.remote.channel.message.sms.service.RemoteEmailMessageService;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/remote/channel/message/email/")
public class RemoteEmailMessageController {


    @Autowired
    RemoteEmailMessageService remoteEmailMessageService;
    ...
    public ResponseEntity<?> apiGetOperationSmsMessage(@RequestParam long agentId,
        ...
        ApiOperationSmsMessageWSModel response = remoteEmailMessageService.apiGetOperationSmsMessageService(agentId,sessionId);
