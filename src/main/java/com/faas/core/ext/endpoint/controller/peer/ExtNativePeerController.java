package com.faas.core.ext.endpoint.controller.peer;
...
import com.faas.core.utils.config.ExtRoute;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/ext/peer/native/")
public class ExtNativePeerController {
    ...
    @RequestMapping(value = ExtRoute.API_GET_AGENT_SIP_ACCOUNT, method = RequestMethod.POST)
