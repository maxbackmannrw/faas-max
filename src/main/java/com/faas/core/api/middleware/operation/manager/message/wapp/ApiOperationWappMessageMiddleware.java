package com.faas.core.api.middleware.operation.manager.message.wapp;

import com.faas.core.api.framework.operation.manager.message.wapp.ApiOperationWappMessageFramework;
import com.faas.core.api.model.ws.operation.manager.message.wapp.ApiOperationWappMessageAccountWSModel;
import com.faas.core.api.model.ws.operation.manager.message.wapp.ApiOperationWappMessageChannelWSModel;
import com.faas.core.api.model.ws.operation.manager.message.wapp.ApiOperationWappMessageTempWSModel;
import com.faas.core.api.model.ws.operation.manager.message.wapp.ApiOperationWappMessageWSModel;
import com.faas.core.api.model.ws.operation.manager.message.wapp.dto.ApiOperationWappMessageAccountWSDTO;
import com.faas.core.api.model.ws.operation.manager.message.wapp.dto.ApiOperationWappMessageChannelWSDTO;
import com.faas.core.api.model.ws.operation.manager.message.wapp.dto.ApiOperationWappMessageTempWSDTO;
import com.faas.core.api.model.ws.operation.manager.message.wapp.dto.ApiOperationWappMessageWSDTO;
