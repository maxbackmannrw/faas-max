package com.faas.core.api.middleware.operation.manager.channel.message;

import com.faas.core.api.framework.operation.manager.channel.message.ApiOperationWappMessageFramework;
import com.faas.core.api.model.ws.operation.manager.channel.message.ApiOperationWappMessageAccountWSModel;
import com.faas.core.api.model.ws.operation.manager.channel.message.ApiOperationWappMessageChannelWSModel;
import com.faas.core.api.model.ws.operation.manager.channel.message.ApiOperationWappMessageTempWSModel;
import com.faas.core.api.model.ws.operation.manager.channel.message.ApiOperationWappMessageWSModel;
import com.faas.core.api.model.ws.operation.manager.channel.message.dto.ApiOperationWappMessageAccountWSDTO;
import com.faas.core.api.model.ws.operation.manager.channel.message.dto.ApiOperationWappMessageChannelWSDTO;
import com.faas.core.api.model.ws.operation.manager.channel.message.dto.ApiOperationWappMessageTempWSDTO;
import com.faas.core.api.model.ws.operation.manager.channel.message.dto.ApiOperationWappMessageWSDTO;
