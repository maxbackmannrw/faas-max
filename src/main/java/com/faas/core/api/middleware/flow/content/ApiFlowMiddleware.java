...
public class ApiFlowMiddleware {
    ...
    public ApiAgentFlowWSModel apiGetAgentFlows(long agentId, int reqPage, int reqSize) {

        ApiAgentFlowWSModel response = new ApiAgentFlowWSModel();
        GeneralWSModel general = new GeneralWSModel();


        general.setOperation("apiGetAgentFlows");
    ...
    public ApiFlowWSModel apiGetCampaignFlows(long agentId, String campaignId, String flowState, int reqPage, int reqSize) {

        ApiFlowWSModel response = new ApiFlowWSModel();
        GeneralWSModel general = new GeneralWSModel();


        general.setOperation("apiGetCampaignFlows");
        general.setStatus(AppConstant.GENERAL_SUCCESS_STATUS);
        general.setStatusCode(AppConstant.GENERAL_SUCCESS_CODE);
        general.setResult(AppConstant.GENERAL_SUCCESS_STATUS);
        response.setGeneral(general);
