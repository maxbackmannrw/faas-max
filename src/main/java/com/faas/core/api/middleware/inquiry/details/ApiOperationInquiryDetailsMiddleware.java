...
public class ApiOperationInquiryDetailsMiddleware {
    ...
    public ApiInquiryDetailsWSModel apiGetOperationInquiryDetails(long agentId, long inquiryId) {
        ...
        ApiInquiryDetailsWSDTO inquiryDetailsWSDTO  = apiOperationInquiryDetailsFramework.apiGetOperationInquiryDetailsService(agentId,inquiryId);
    ...
    public ApiSummaryWSModel apiGetOperationInquirySummary(long agentId) {
        ...
        List<ApiSummaryWSDTO> inquirySummaries  = apiOperationInquiryDetailsFramework.apiGetOperationInquirySummaryService(agentId);
