 ...
 public class ApiOperationInquiryContent {

    private ClientDBModel client;
    private SessionDBModel clientSession;
    private OperationInquiryDBModel clientInquiry;

     public ApiOperationInquiryContent() {
     }

     public ApiOperationInquiryContent(ClientDBModel client, SessionDBModel clientSession, OperationInquiryDBModel clientInquiry) {
         this.client = client;
