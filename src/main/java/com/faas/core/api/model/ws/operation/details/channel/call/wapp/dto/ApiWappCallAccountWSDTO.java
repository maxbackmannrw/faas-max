...
public class ApiWappCallAccountWSDTO {
    ...
    public ApiWappCallAccountWSDTO() {
    }

    public ApiWappCallAccountWSDTO(String accountId, String account, String instanceKey, String phoneNumber, String serverUrl, List<AccountDataDAO> accountDatas, String callStatus, String messageStatus, long cDate, int status) {
