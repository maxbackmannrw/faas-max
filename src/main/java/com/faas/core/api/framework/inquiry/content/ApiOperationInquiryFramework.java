...
public class ApiOperationInquiryFramework {
    ...
    public ApiAgentOperationInquiryWSDTO apiGetAgentOperationInquiriesService(long agentId, int reqPage, int reqSize){
    ...
    public ApiOperationInquiryWSDTO apiGetCampaignOperationInquiriesService(long agentId, String campaignId, String inquiryState, int reqPage, int reqSize){
    ...
    public ApiOperationInquiryWSDTO apiGetOperationInquiriesService(long agentId, String inquiryState, int reqPage, int reqSize){
