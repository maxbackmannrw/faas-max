...
public class ApiOperationManagerController {
    ...
    public ResponseEntity<?> apiGetOperationActivities(@RequestParam long agentId,
        ...
        ApiOperationActivityWSModel response = operationManagerMiddleware.apiGetOperationActivities(agentId, operationId);
    ...
    public ResponseEntity<?> apiGetOperationActivity(@RequestParam long agentId,
        ...
        ApiOperationActivityWSModel response = operationManagerMiddleware.apiGetOperationActivity(agentId, operationId, activityId);
