package com.faas.core.api.endpoint.controller.operation.remote;

import com.faas.core.api.middleware.operation.remote.ApiOperationRemoteMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/operation/remote/")
