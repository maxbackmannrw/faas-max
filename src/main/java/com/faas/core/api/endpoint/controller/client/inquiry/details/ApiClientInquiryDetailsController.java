...
package com.faas.core.api.endpoint.controller.client.inquiry.details;

import com.faas.core.api.middleware.client.inquiry.details.ApiClientInquiryDetailsMiddleware;
...
public class ApiClientInquiryDetailsController {
    ...
    public ResponseEntity<?> apiGetOperationInquiryDetails(@RequestParam long agentId,
        ...
        ApiInquiryDetailsWSModel response = apiClientInquiryDetailsMiddleware.apiGetOperationInquiryDetails(agentId,inquiryId);
    ...
    public ResponseEntity<?> apiGetOperationInquirySummary(@RequestParam long agentId) {
        ...
        ApiSummaryWSModel response = apiClientInquiryDetailsMiddleware.apiGetOperationInquirySummary(agentId);
