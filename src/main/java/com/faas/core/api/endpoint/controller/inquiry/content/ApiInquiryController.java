...
public class ApiInquiryController {
    ...
    @RequestMapping(value = ApiRoute.API_GET_AGENT_INQUIRIES, method = RequestMethod.POST)
    public ResponseEntity<?> apiGetAgentInquiries(@RequestParam long agentId,
                                                  @RequestParam int reqPage,
                                                  @RequestParam int reqSize) {

        ApiAgentInquiryWSModel response = apiInquiryMiddleware.apiGetAgentInquiries(agentId,reqPage,reqSize);
    ...
    public ResponseEntity<?> apiGetCampaignInquiries(@RequestParam long agentId,
        ...
        ApiOperationInquiryWSModel response = apiInquiryMiddleware.apiGetCampaignInquiries(agentId,campaignId,inquiryState,reqPage,reqSize);
    ...
    public ResponseEntity<?> apiGetInquiries(@RequestParam long agentId,
        ...
        ApiOperationInquiryWSModel response = apiInquiryMiddleware.apiGetInquiries(agentId,inquiryState,reqPage,reqSize);
