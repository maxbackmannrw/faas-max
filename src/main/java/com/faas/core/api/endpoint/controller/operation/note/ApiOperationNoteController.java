package com.faas.core.api.endpoint.controller.operation.note;

import com.faas.core.api.middleware.operation.note.ApiOperationNoteMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/operation/note/")
