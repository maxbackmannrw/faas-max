...
package com.faas.core.api.endpoint.controller.client.flow.content;

import com.faas.core.api.middleware.client.flow.content.ApiClientFlowMiddleware;
...
public class ApiClientFlowController {
    ...
    @Autowired
    ApiClientFlowMiddleware apiClientFlowMiddleware;
    ...
    public ResponseEntity<?> apiGetAgentOperationFlows(@RequestParam long agentId,
        ...
        ApiAgentFlowWSModel response = apiClientFlowMiddleware.apiGetAgentOperationFlows(agentId,reqPage,reqSize);
    ...
    public ResponseEntity<?> apiGetCampaignOperationFlows(@RequestParam long agentId,
        ...
        ApiFlowWSModel response = apiClientFlowMiddleware.apiGetCampaignOperationFlows(agentId,campaignId,flowState,reqPage,reqSize);
    ...
    public ResponseEntity<?> apiGetOperationFlows(@RequestParam long agentId,
        ...
        ApiFlowWSModel response = apiClientFlowMiddleware.apiGetOperationFlows(agentId,flowState,reqPage,reqSize);
    ...
    public ResponseEntity<?> apiGetOperationFlow(@RequestParam long agentId,
        ...
        ApiFlowWSModel response = apiClientFlowMiddleware.apiGetOperationFlow(agentId,flowId,campaignId);
    ...
    public ResponseEntity<?> apiStartOperationFlow(@RequestParam long agentId,
        ...
        ApiFlowWSModel response = apiClientFlowMiddleware.apiStartOperationFlow(agentId,flowId,sessionId,campaignId);
    ...
    public ResponseEntity<?> apiUpdateOperationFlow(@RequestParam long agentId,
        ...
        ApiFlowWSModel response = apiClientFlowMiddleware.apiUpdateOperationFlow(agentId,flowId,flowState);
    ...
    public ResponseEntity<?> apiRemoveOperationFlow(@RequestParam long agentId,
        ...
        ApiFlowWSModel response = apiClientFlowMiddleware.apiRemoveOperationFlow(agentId,flowId);
