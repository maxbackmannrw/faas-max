package com.faas.core.api.endpoint.controller.operation.channel.content;

import com.faas.core.api.middleware.operation.channel.content.ApiOperationChannelMiddleware;
import com.faas.core.api.model.ws.operation.channel.content.ApiOperationCallChannelWSModel;
import com.faas.core.api.model.ws.operation.channel.content.ApiOperationMessageChannelWSModel;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/operation/channel/")
