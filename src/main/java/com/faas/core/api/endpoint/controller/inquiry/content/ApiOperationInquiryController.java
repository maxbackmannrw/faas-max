...
public class ApiOperationInquiryController {
    ...
    public ResponseEntity<?> apiGetAgentOperationInquiries(@RequestParam long agentId,
        ...
        ApiAgentInquiryWSModel response = apiOperationInquiryMiddleware.apiGetAgentOperationInquiries(agentId,reqPage,reqSize);
    ...
    public ResponseEntity<?> apiGetCampaignOperationInquiries(@RequestParam long agentId,
        ...
        ApiInquiryWSModel response = apiOperationInquiryMiddleware.apiGetCampaignOperationInquiries(agentId,campaignId,inquiryState,reqPage,reqSize);
    ...
    public ResponseEntity<?> apiGetOperationInquiries(@RequestParam long agentId,
        ...
        ApiInquiryWSModel response = apiOperationInquiryMiddleware.apiGetOperationInquiries(agentId,inquiryState,reqPage,reqSize);
