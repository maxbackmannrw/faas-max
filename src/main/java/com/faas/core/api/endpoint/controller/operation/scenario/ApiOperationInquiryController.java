...
import com.faas.core.api.middleware.operation.scenario.ApiOperationInquiryMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/operation/scenario/inquiry/")
