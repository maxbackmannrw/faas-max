package com.faas.core.api.endpoint.controller.operation.osint;

import com.faas.core.api.middleware.operation.osint.ApiOperationOSINTMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/operation/osint/")
