package com.faas.core.api.endpoint.controller.operation.channel.message;

import com.faas.core.api.middleware.operation.channel.message.ApiOperationPushMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/operation/channel/message/push/")
