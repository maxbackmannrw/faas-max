package com.faas.core.api.endpoint.controller.operation.manager.channel.message;

import com.faas.core.api.middleware.operation.manager.channel.message.ApiOperationSmsMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/operation/manager/channel/message/sms/")
