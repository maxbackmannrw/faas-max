...
public class ApiFlowDetailsController {
    ...
    public ResponseEntity<?> apiGetOperationFlowDetails(@RequestParam long agentId,
        ...
        ApiFlowDetailsWSModel response = apiFlowDetailsMiddleware.apiGetOperationFlowDetails(agentId,inquiryId);
    ...
    public ResponseEntity<?> apiGetOperationFlowSummary(@RequestParam long agentId) {
        ...
        ApiSummaryWSModel response = apiFlowDetailsMiddleware.apiGetOperationFlowSummary(agentId);
