...
public class ApiInquiryDetailsController {
    ...
    public ResponseEntity<?> apiGetOperationInquiryDetails(@RequestParam long agentId,
        ...
        ApiInquiryDetailsWSModel response = apiInquiryDetailsMiddleware.apiGetOperationInquiryDetails(agentId,inquiryId);
    ...
    public ResponseEntity<?> apiGetOperationInquirySummary(@RequestParam long agentId) {
        ...
        ApiSummaryWSModel response = apiInquiryDetailsMiddleware.apiGetOperationInquirySummary(agentId);
