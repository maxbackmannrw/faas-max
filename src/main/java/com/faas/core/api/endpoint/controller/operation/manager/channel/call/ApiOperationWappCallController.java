package com.faas.core.api.endpoint.controller.operation.manager.channel.call;

import com.faas.core.api.middleware.operation.manager.channel.call.ApiOperationWappCallMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/operation/manager/channel/call/wapp/")
