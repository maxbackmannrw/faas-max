package com.faas.core.api.endpoint.controller.operation.manager.client.remoteapp;

import com.faas.core.api.middleware.operation.manager.client.remoteapp.ApiOperationRemoteAppMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/operation/manager/client/remoteapp/")
