package com.faas.core.base.controller.remote.content;

import com.faas.core.base.middleware.remote.content.RemoteMiddleware;
import com.faas.core.data.ws.base.remote.content.RemoteWSModel;
...
public class RemoteController {
    ...
    public ResponseEntity<?> createRemote(@RequestParam long userId,
        ...
        RemoteWSModel response = remoteMiddleware.createRemote(userId, remote, remoteDesc, version, baseUrl, typeId);
