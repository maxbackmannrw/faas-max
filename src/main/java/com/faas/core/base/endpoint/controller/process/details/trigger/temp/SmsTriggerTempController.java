...
import com.faas.core.base.middleware.process.details.trigger.temp.SmsTriggerTempMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/process/details/trigger/temp/sms/")
