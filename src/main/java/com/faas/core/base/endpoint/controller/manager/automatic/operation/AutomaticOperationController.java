package com.faas.core.base.endpoint.controller.manager.automatic.operation;

import com.faas.core.base.middleware.manager.automatic.operation.AutomaticOperationMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/manager/automatic/operation/")
