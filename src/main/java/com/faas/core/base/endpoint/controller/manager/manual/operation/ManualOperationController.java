package com.faas.core.base.endpoint.controller.manager.manual.operation;

import com.faas.core.base.middleware.manager.manual.operation.ManualOperationMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/manager/manual/operation/")
