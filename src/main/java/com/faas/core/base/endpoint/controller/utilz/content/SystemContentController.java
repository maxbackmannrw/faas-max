package com.faas.core.base.endpoint.controller.utilz.content;

import com.faas.core.base.middleware.utilz.content.SystemContentMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/utilz/content/")
