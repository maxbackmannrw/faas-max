package com.faas.core.base.endpoint.controller.manager.operation.details.inquiry;

import com.faas.core.base.middleware.manager.operation.details.inquiry.InquiryOperationMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/manager/operation/details/inquiry/")
public class InquiryOperationController {
    ...
    public ResponseEntity<?> getOperationManagerDetails(@RequestParam long userId) {
        ...
        InquiryManagerWSModel response = inquiryOperationMiddleware.getOperationManagerDetails(userId);
