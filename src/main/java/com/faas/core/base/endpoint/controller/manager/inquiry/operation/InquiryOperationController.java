package com.faas.core.base.endpoint.controller.manager.inquiry.operation;

import com.faas.core.base.middleware.manager.inquiry.operation.InquiryOperationMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/manager/inquiry/operation/")
