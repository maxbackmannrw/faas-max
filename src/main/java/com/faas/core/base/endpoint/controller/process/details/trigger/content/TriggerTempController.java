...
import com.faas.core.base.middleware.process.details.trigger.content.TriggerTempMiddleware;
...
public class TriggerTempController {


    @Autowired
    TriggerTempMiddleware triggerTempMiddleware;
    ...
    public ResponseEntity<?> getProcessTriggerTemps(@RequestParam long userId,
        ...
        ProcessTriggerTempWSModel response = triggerTempMiddleware.getProcessTriggerTemps(userId,processId);
