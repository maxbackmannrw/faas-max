package com.faas.core.base.endpoint.controller.operation.details.manual;

import com.faas.core.base.middleware.operation.details.manual.ManualOperationMiddleware;
...
public class ManualOperationController {
    ...
    public ResponseEntity<?> getManualOperations(@RequestParam long userId,
        ...
        InquiryOperationWSModel response = manualOperationMiddleware.getManualOperations(userId,reqPage,reqSize);
    ...
    public ResponseEntity<?> getManualOperation(@RequestParam long userId,
        ...
        InquiryOperationWSModel response = manualOperationMiddleware.getManualOperation(userId,reqPage,reqSize);
    ...
    public ResponseEntity<?> createManualOperation(@RequestParam long userId,
        ...
        InquiryOperationWSModel response = manualOperationMiddleware.createManualOperation(userId,reqPage,reqSize);
    ...
    public ResponseEntity<?> updateManualOperation(@RequestParam long userId,
        ...
        InquiryOperationWSModel response = manualOperationMiddleware.updateManualOperation(userId,reqPage,reqSize);
    ...
    public ResponseEntity<?> removeManualOperation(@RequestParam long userId,
        ...
        InquiryOperationWSModel response = manualOperationMiddleware.removeManualOperation(userId,sessionId,operationId);
