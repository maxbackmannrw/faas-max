...
import com.faas.core.base.middleware.campaign.details.channel.temp.CampaignPushTempMiddleware;
import com.faas.core.base.model.ws.campaign.details.channel.temp.CampaignPushTempWSModel;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/campaign/details/channel/temp/push/")
