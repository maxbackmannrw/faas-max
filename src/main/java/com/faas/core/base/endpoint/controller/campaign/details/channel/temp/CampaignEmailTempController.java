...
import com.faas.core.base.middleware.campaign.details.channel.temp.CampaignEmailTempMiddleware;
import com.faas.core.base.model.ws.campaign.details.channel.temp.CampaignEmailTempWSModel;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/campaign/details/channel/temp/email/")
