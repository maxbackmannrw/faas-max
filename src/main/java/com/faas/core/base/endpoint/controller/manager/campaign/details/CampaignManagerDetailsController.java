package com.faas.core.base.endpoint.controller.manager.campaign.details;

import com.faas.core.base.middleware.manager.campaign.details.CampaignManagerDetailsMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/manager/campaign/details/")
