...
public class IOSRemoteDAO {
    ...
    public IOSRemoteDAO(String id, String remoteBrand, String remoteModel, String remoteOS, String remoteUrl, long uDate, long cDate, int status) {
        this.id = id;
