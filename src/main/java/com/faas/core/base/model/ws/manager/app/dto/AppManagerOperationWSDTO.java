...
public class AppManagerOperationWSDTO {
    ...
    public AppManagerOperationWSDTO() {
    }

    public AppManagerOperationWSDTO(List<CampaignManagerWSDTO> manualCampaigns, List<CampaignManagerWSDTO> inquiryCampaigns, List<CampaignManagerWSDTO> automaticCampaigns, OperationManagerWSDTO readyOperation, OperationManagerWSDTO activeOperation, OperationManagerWSDTO finishedOperation) {
