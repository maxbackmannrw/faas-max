...
public class ScenarioAutomationExecutionDAO {
    ...
    public ScenarioAutomationExecutionDAO() {
    }

    public ScenarioAutomationExecutionDAO(long automationId, String automation, String automationType, List<ScenarioDataDAO> automationDatas, long uDate, long cDate, int status) {
