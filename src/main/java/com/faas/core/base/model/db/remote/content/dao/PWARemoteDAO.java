...
public class PWARemoteDAO {
    ...
    public PWARemoteDAO(String id, String remoteBrand, String remoteModel, String remoteOS, String remoteUrl, long uDate, long cDate, int status) {
        this.id = id;
