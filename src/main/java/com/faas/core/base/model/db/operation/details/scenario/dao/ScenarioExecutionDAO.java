package com.faas.core.base.model.db.operation.details.scenario.dao;
...
public class ScenarioExecutionDAO {
    ...
    public ScenarioExecutionDAO(String id, String elementId, String element, String elementType, ActionDAO action, AutomationDAO automation, List<ScenarioExecutionValue> executionValues, long uDate, long cDate, int status) {
        this.id = id;
