package com.faas.core.base.model.db.remote.client.dao;
...
public class ClientRemoteDAO {
    ...
    public ClientRemoteDAO(String id, String remoteBrand, String remoteModel, String remoteOS, String remoteUrl, long uDate, long cDate, int status) {
        this.id = id;
