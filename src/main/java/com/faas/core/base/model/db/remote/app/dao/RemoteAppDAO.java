...
public class RemoteAppDAO {
    ...
    public RemoteAppDAO(String id, String remoteBrand, String remoteModel, String remoteOS, String remoteUrl, long uDate, long cDate, int status) {
        this.id = id;
