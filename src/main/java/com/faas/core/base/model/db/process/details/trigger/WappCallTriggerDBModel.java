...
public class WappCallTriggerDBModel {
    ...
    public WappCallTriggerDBModel(String account, String accountId, long cDate, List<TriggerDataDAO> datas, String id, String processId, int status, String trigger, String triggerDesc, String triggerType, long typeId, long uDate) {
