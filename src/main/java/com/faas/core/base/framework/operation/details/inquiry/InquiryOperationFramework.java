package com.faas.core.base.framework.operation.details.inquiry;
...
public class InquiryOperationFramework {
    ...
    public List<InquiryOperationWSDTO> getInquiryOperationsService(long userId, int reqPage, int reqSize) {
    ...
    public InquiryOperationWSDTO getInquiryOperationService(long userId, long inquiryId, long clientId) {
    ...
    public InquiryOperationWSDTO createInquiryOperationService(long userId, long inquiryId, long clientId) {
    ...
    public InquiryOperationWSDTO removeInquiryOperationService(long userId, long inquiryId, long clientId) {
