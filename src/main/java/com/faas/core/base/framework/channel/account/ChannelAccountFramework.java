...
import com.faas.core.api.service.channel.call.wapp.ApiWappCallService;
...
public class ChannelAccountFramework {
    ...
    @Autowired
    ApiWappCallService apiWappCallService;
    ...
    public WappQRCodeWSDTO getWappAccountQRCodeService(String accountId) throws IOException {
        ...
        if (wappAccountDBModel.isPresent()){
            String qrCodeInBase64 = apiWappCallService.getWappQRCodeInBase64Service(wappAccountDBModel.get().getServerUrl(),wappAccountDBModel.get().getInstanceKey());
    ...
    public WappAccountDBModel createWappAccountService(String account,String phoneNumber, String serverUrl) throws IOException {
        ...
        String instanceKey = apiWappCallService.initWappInstanceService(serverUrl);
        if (instanceKey != null){
