...
import com.faas.core.utils.service.channel.call.wapp.WappCallChannelService;
...
public class ChannelAccountFramework {
    ...
    @Autowired
    WappCallChannelService wappCallChannelService;
    ...
    public WappQRCodeWSDTO getWappAccountQRCodeService(String accountId) throws IOException {
        ...
        if (wappAccountDBModel.isPresent()){
            String qrCodeInBase64 = wappCallChannelService.getWappQRCodeInBase64Service(wappAccountDBModel.get().getServerUrl(),wappAccountDBModel.get().getInstanceKey());
    ...
    public WappAccountDBModel createWappAccountService(String account,String phoneNumber, String serverUrl) throws IOException {
        ...
        String instanceKey = wappCallChannelService.initWappInstanceService(serverUrl);
        if (instanceKey != null){
