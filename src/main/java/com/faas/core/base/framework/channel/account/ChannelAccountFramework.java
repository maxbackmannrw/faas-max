...
import com.faas.core.utils.service.channel.call.wapp.WappCallService;
...
public class ChannelAccountFramework {
    ...
    @Autowired
    WappCallService wappCallService;
    ...
    public WappQRCodeWSDTO getWappAccountQRCodeService(String accountId) throws IOException {
        ...
        if (wappAccountDBModel.isPresent()){
            String qrCodeInBase64 = wappCallService.getWappQRCodeInBase64Service(wappAccountDBModel.get().getServerUrl(),wappAccountDBModel.get().getInstanceKey());
    ...
    public WappAccountDBModel createWappAccountService(String account,String phoneNumber, String serverUrl) throws IOException {
        ...
        String instanceKey = wappCallService.initWappInstanceService(serverUrl);
        if (instanceKey != null){
