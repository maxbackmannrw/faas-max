package com.faas.core.external.endpoint.controller.channel.message;
...
import com.faas.core.utils.config.ExternalRoute;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/external/channel/message/email/")
public class ExtEmailMessageController {
    ...
    @RequestMapping(value = ExternalRoute.API_GET_AGENT_SIP_ACCOUNT, method = RequestMethod.POST)
