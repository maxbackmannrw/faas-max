package com.faas.core.external.endpoint.controller.channel.call;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/external/channel/call/wapp/")
public class ExtWappCallController {
