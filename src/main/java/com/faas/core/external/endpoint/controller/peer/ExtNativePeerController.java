package com.faas.core.external.endpoint.controller.peer;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/external/peer/native/")
public class ExtNativePeerController {
