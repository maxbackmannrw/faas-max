package com.faas.core.external.endpoint.controller.utils;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/external/utils/utility/")
public class ExtUtilityController {
