...
public class BaseRoute {
    ...
    public static final String UPDATE_CAMPAIGN_AGENT_STATE = "updatecampaignagentstate";
    ...
    public static final String GET_SYSTEM_CONTENTS = "getsystemcontents";
    public static final String RECOVER_SYSTEM_CONTENT = "recoversystemcontent";
    public static final String REMOVE_SYSTEM_CONTENT = "removesystemcontent";
